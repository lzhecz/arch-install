...
# Install packages
yay -S brave polkit-gnome nitrogen lxappearance-gtk3 pcmanfm
...
yay -S zsh rofi picom-animations-git gpick xclip imagemagick dunst betterlockscreen-git lf flameshot tigervnc gparted gnome-disks
